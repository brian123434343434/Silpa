...
<body>
    ...
    <tr><td>
        <asp:GridView style="TEXT-ALIGN: Left" id="grdDetalleSalvoconductos" runat="server" AutoGenerateColumns="False" Font-Names="Tahoma" >
            <Columns>
                <asp:BoundField DataField="VALORCAMPO" meta:resourceKey="BoundFieldResource1"></asp:BoundField>
                <asp:BoundField DataField="VALOR" meta:resourceKey="BoundFieldResource2"></asp:BoundField>
            </Columns>
        </asp:GridView>
        </td>
        </tr>
