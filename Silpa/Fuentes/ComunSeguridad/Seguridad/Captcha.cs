...
namespace SILPA.ComunSeguridad
{
    public static class Captcha
    {
        ...
        #region Metodos Privados
            ...
            private static void DrawCaptchaCode(Graphics graph, Random rand, int width, int height, string captchaCode)
            {
            ...
            private static void DrawDisorderLine(Graphics graph, Random rand, int width, int height, string captchaCode)
            {
            ...
            public static CaptchaResult GenerateCaptchaImage(int width, int height, string captchaCode)
            {
                using (Bitmap baseMap = new Bitmap(width, height)){
                    using (Graphics graph = Graphics.FromImage(baseMap))
                    {
                        ...
                        DrawCaptchaCode(graph, rand, width, height, captchaCode);

                        DrawDisorderLine(graph, rand, width, height, captchaCode);
