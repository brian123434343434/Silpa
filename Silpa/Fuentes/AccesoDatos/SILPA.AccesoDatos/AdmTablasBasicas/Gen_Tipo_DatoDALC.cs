...
{
    public class Gen_Tipo_DatoDALC
    {
        private Configuracion objConfiguracion;
        public Gen_Tipo_DatoDALC()
        {
        ...
        public DataTable Listar_Gen_Tipo_Dato(string strDescripcion)
        {
            try
            {
                ...
                DbCommand cmd = db.GetStoredProcCommand("BAS_LISTA_GEN_TIPO_DATO", parametros);
        ...
        public void Insertar_Gen_Tipo_Dato(string strDescripcion, byte byEstado)
        {
            try
            {
                ...
                DbCommand cmd = db.GetStoredProcCommand("BAS_INSERTAR_GEN_TIPO_DATO", parametros);
        ...
        public void Actualizar_Gen_Tipo_Dato(int iID, string strDescripcion, byte byEstado)
        {
            try
            {
                ...
                DbCommand cmd = db.GetStoredProcCommand("BAS_ACTUALIZAR_GEN_TIPO_DATO", parametros);
                db.ExecuteNonQuery(cmd);
            }
            catch (SqlException sql)
            {
        ...
        public void Eliminar_Gen_Tipo_Dato(int iID)
        {
            try
            {
                ...
                DbCommand cmd = db.GetStoredProcCommand("BAS_ELIMINAR_GEN_TIPO_DATO", parametros);
                db.ExecuteNonQuery(cmd);
            }
            catch (SqlException sql)
            {
