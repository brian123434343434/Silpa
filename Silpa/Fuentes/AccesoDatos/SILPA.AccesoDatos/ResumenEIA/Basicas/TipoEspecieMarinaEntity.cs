...
{
    public class TipoEspecieMarinaEntity
    {
        private System.Int32 _ETM_ID;
        private System.String _ETM_TIPO_ESPECIE_MARINA;
        ...
        public System.String ETM_TIPO_ESPECIE_MARINA
        {
            get
            {
                return ajustarAncho(_ETM_TIPO_ESPECIE_MARINA, 100);
            }
            set
            {
                _ETM_TIPO_ESPECIE_MARINA = value;
            }
        }
        ...
        public string this[int index]
        {
            ...
            get
            {
                ...
                {
                    return this.ETM_TIPO_ESPECIE_MARINA.ToString();
                }
                else if (index == 2)
                {
            ...
            set
            {
                ...
                {
                    this.ETM_TIPO_ESPECIE_MARINA = value;
                }
                else if (index == 2)
                {
                    try
        ...
        public string this[string index]
        {
            ...
            get
            {
                ...
                else if (index == "ETM_TIPO_ESPECIE_MARINA")
                {
                    return this.ETM_TIPO_ESPECIE_MARINA.ToString();
                }
