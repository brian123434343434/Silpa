...
{
    public class TipoOleajeEntity
    {
        private System.Int32 _ETO_ID;
        private System.String _ETO_TIPO_OLEAJE;
        ...
        public System.String ETO_TIPO_OLEAJE
        {
            get
            {
                return ajustarAncho(_ETO_TIPO_OLEAJE, 100);
            }
            set
            {
                _ETO_TIPO_OLEAJE = value;
            }
        }
        ...
        public string this[int index]
        {
            ...
            get
            {
                ...
                {
                    return this.ETO_TIPO_OLEAJE.ToString();
                }
                else if (index == 2)
                {
