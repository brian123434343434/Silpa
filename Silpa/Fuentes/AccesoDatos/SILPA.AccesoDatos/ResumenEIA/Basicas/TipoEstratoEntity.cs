...
{
    public class TipoEstratoEntity
    {
        private System.Int32 _ETE_ID;
        private System.String _ETE_TIPO_ESTRATO_ECOTERR;
        ...
        public System.String ETE_TIPO_ESTRATO_ECOTERR
        {
            get
            {
                return ajustarAncho(_ETE_TIPO_ESTRATO_ECOTERR, 100);
            }
            set
            {
                _ETE_TIPO_ESTRATO_ECOTERR = value;
            }
        }
        ...
        public string this[int index]
        {
            ...
            get
            {
                ...
                {
                    return this.ETE_TIPO_ESTRATO_ECOTERR.ToString();
                }
                else if (index == 2)
                {
            ...
            set
            {
                ...
                {
                    this.ETE_TIPO_ESTRATO_ECOTERR = value;
                }
                else if (index == 2)
                {
                    try
        ...
        public string this[string index]
        {
            ...
            get
            {
                ...
                else if (index == "ETE_TIPO_ESTRATO_ECOTERR")
                {
                    return this.ETE_TIPO_ESTRATO_ECOTERR.ToString();
                }
