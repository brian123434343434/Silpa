...
{
   public class ComplementoDireccionIdentity : EntidadSerializable
    {
        /// <summary>
        /// Constructor sin parametros
        /// </summary>
        public ComplementoDireccionIdentity() { }
        ...
        public ComplementoDireccionIdentity(int intId, string strNombre, bool blnActivo)
        {
            this._id = intId;
