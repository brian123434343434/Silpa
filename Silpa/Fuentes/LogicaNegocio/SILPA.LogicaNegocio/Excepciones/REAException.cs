...
namespace SILPA.LogicaNegocio.Excepciones
{
    public class REAException : Exception
    {
        ...
        public REAException(string message, System.Exception inner) : base(message, inner) { }
        ...
        public REAException(PDVDalcException p_objException) : base(p_objException.Message, p_objException.InnerException) { }
    }
}
