...
{
    public class SolicitudREAException: Exception
    {
        /// <summary>
        /// Exepcion ocurrida durante el acceso a datos
        /// </summary>
        public SolicitudREAException() : base() { }

        /// <summary>
        /// Exepcion ocurrida durante el acceso a datos
        /// </summary>
        /// <param name="message">string que contiene el mensaje de error presentado</param>
        public SolicitudREAException(string message) : base(message) { }
        ...
        public SolicitudREAException(string message, System.Exception inner) : base(message, inner) { }
    }
}
